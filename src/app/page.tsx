      ...
      <div className="space-y-3 w-full">
        ...
        <div className="space-y-3 w-full">
          ...
          <div className="space-x-3 flex flex-col items-start">
            ...
            <input spellCheck={false} name="Password" className="bg-white bg-opacity-20 border border-gray-200 outline-none w-3/4"></input>
          </div>
          <div className="space-x-3 flex flex-col items-start">
            <label htmlFor="renter" className="pl-3">Re-Enter password</label>
            <input name="renter" spellCheck={false} className="bg-white bg-opacity-20 border border-gray-200 outline-none w-3/4"></input>
          </div>
            <div>
